...
<div class="scene">
  ...
  <div class="text">
    ...
    <span class="msg">can't let <span>you</span> in (Access Denied).</span>
    <span class="support">
      <span>unexpected?</span>
      <?php if(!sess()->get('pclogin')){?>
        <a href="<?=base_url('pclogin')?>">Login</a>
        <br>
        <?php }?>
      <a href="<?=base_url('cwnu')?>">Home Page</a> 
      <br>
      <a href="<?=base_url('admins')?>">Contact support</a>
    </span>
  </div>
  <div class="lock"></div>
</div></body>
