...
<title>admin.chinesetest.cn</title>
<style>
...
<!-- Bootstrap -->
<link rel="stylesheet" href="./chineseteste-cn.com_files/phone.css" type="text/css">
				...
				<table class="table table-bordered">
					<tbody>
						<tr>
							...
							<td>MOHAMMAD EBRAHIM SHARIFI</td>
							<td rowspan="5" width="100px">
								
									
									
										<img src="assets/img/photo" height="200px">
						...
						<tr>
							...
							<td colspan="2">川北医学院（高坪校区）(网考)</td>
						</tr>
						<tr>
							<td class="active text-right">Ticket No.</td>
							<td colspan="2">H32405988040100019 &nbsp;&nbsp;H72405988040100019</td>  
						</tr>
						<tr>
							<td class="active text-right">证书编号</td>
							<td colspan="2">HW2406045905</td>
						</tr>
						<tr>
